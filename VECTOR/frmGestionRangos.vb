            ...
            Using uow As New UnitOfWork()
                ...
                If rango.Activo Then
                    ...
                    If rango.IdOficina.HasValue Then
                        ...
                        otrosQuery = otrosQuery.Where(Function(x) x.IdOficina.HasValue AndAlso x.IdOficina.Value = idOficina)
                    Else
                        otrosQuery = otrosQuery.Where(Function(x) Not x.IdOficina.HasValue)
                    End If
                    Dim otros = Await otrosQuery.ToListAsync()
                    For Each o In otros
                        o.Activo = False
                    Next
                End If
